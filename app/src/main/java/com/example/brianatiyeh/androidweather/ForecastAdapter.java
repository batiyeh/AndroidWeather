...
public class ForecastAdapter extends ArrayAdapter<Weather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //convertView is the actual list object
        if (convertView == null){
        ...
        //API's timestamp is in a different format so we convert
        cal.setTimeInMillis(weather.getTimestamp() * 1000);
        String dayText = daysOfWeek[cal.get(Calendar.DAY_OF_WEEK) - 1];
